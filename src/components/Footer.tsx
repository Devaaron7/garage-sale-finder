    ...
    <FooterContainer>
      <Content>
        ...
        <Links>
          ...
          <Link href="https://github.com/Devaaron7/aaron-tracy-resume/blob/main/Aaron_Tracy_Software_Engineer_2025.pdf" target="_blank" rel="noopener noreferrer">Contact Me</Link>
        </Links>
        <Attribution>
